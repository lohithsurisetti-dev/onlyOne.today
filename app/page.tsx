          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-3">
                ...
                <button className="sm:hidden px-8 py-3.5 rounded-full bg-white/10 hover:bg-white/20 border border-white/20 text-white hover:border-white/40 transition-all duration-300 backdrop-blur-sm hover:scale-105 inline-flex items-center justify-center space-x-2 min-h-[50px]">
